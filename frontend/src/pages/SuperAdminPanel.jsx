  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .sidebar-nav {
          background-color: var(--ui-dark-turquoise-tone) !important;
          background-image: url("data:image/svg+xml,%3Csvg width='42' height='44' viewBox='0 0 42 44' xmlns='http://www.w3.org/2000/svg'%3E%3Cg id='Page-1' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'%3E%3Cg id='brick-wall' fill='%23004d40' fill-opacity='0.1'%3E%3Cpath d='M0,0 L0,44 L21,44 L21,0 L0,0 Z M21,0 L21,22 L42,22 L42,0 L21,0 Z M21,22 L21,44 L42,44 L42,22 L21,22 Z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
        }
        ...
        .welcome-header {
          background-color: var(--ui-turquoise) !important;
          font-size: 1.5rem;
          padding: 1rem;
